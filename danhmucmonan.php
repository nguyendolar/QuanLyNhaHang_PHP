        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Danh sách danh mục món ăn</h1>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                <?php 
                                    $query = "SELECT * FROM danhmucmonan Order by id desc";
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            Danh muc món ăn : <?php echo $arUser["tendanhmuc"] ?>
                                                    ...
                                                    <form action="function.php" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="col-12">
                                                            <label for="category-film"
                                                                class="col-form-label">Tên danh muc món ăn:</label>
                                                                <input type="text" class="form-control" id="category-film" value="<?php echo $arUser["tendanhmuc"] ?>" name="tendanhmuc" required>
                                                        </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <div class="col-12">
                                                            <label for="category-film"
                                                                class="col-form-label">Tên danh muc món ăn:</label>
                                                                <input type="text" class="form-control" id="category-film" name="tendanhmuc" required>
                                                        </div>
                                                        </div>
                                                    </div>
                                                        <div class="modal-footer">
